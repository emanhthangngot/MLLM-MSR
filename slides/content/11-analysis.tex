  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.47\textwidth}\centering\small
      ...
      \resizebox{0.96\linewidth}{!}{\begin{tikzpicture}[x=0.7cm,y=1.8cm]
        ...
        \node[font=\scriptsize,align=center] at (2.5,-0.18) {quá nhỏ: thiếu context\\quá lớn: prompt dài};
      \end{tikzpicture}}
    \end{column}
    \begin{column}{0.47\textwidth}\centering\small
      ...
      \resizebox{0.96\linewidth}{!}{\begin{tikzpicture}[x=0.7cm,y=1.8cm]
        ...
        \node[font=\scriptsize,align=center] at (2.5,-0.18) {ngắn: mất thông tin\\đủ dài: hiệu năng ổn định};
      \end{tikzpicture}}
    \end{column}
  \end{columns}
...
\begin{frame}{Qualitative case: preference summary giúp giải thích dự đoán}
  \includegraphics[width=\textwidth]{qualitative_case_01.png}
