\begin{frame}{SFT objective và LoRA}
  ...
  \vspace{0.2cm}\begin{block}{Cấu hình paper}
    LLaVA-v1.6-Mistral-7B; Llama-3-8B-Instruct cho preference summarization; LoRA rank 8, AdamW learning rate $2\times10^{-5}$, batch size 1, gradient accumulation 8, 10 epochs, max length 512. Đánh số Eq theo paper: (2).
  \end{block}
\end{frame}
